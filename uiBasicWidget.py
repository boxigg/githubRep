...
from ctpquant.eventType import *
from ctpquant.eventEngine import *
from ctpquant.function import *
from ctpquant.gateway import *
    ...
    def updateData(self, data):
        ...
        # 否则采用增量更新模式
            ...
            for n, header in enumerate(self.headerList):
                ...
                cellType = self.headerDict[header]['cellType']
                cell = cellType(content, self.mainEngine)  # , self.mainEngine
...
class MarketMonitor(QtWidgets.QTableWidget):
    ...
    def __init__(self, quoteEngine, eventQuoteEngine, parent=None):
        """Constructor"""
        super(MarketMonitor, self).__init__( parent)
        self.mainEngine = quoteEngine
        self.eventEngine = eventQuoteEngine
        ...
        d['vtSymbol'] = {'chinese':u'名称', 'cellType':BasicCell}
        ...
        d['bidPrice1'] = {'chinese':u'买一价', 'cellType':BasicCell}  #BidCell
        d['bidVolume1'] = {'chinese':u'买一量', 'cellType':BasicCell}  #BidCell
        d['askPrice1'] = {'chinese':u'卖一价', 'cellType':BasicCell} #AskCell
        d['askVolume1'] = {'chinese':u'卖一量', 'cellType':BasicCell} #AskCell
...
class TradeMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        d['direction'] = {'chinese':u'方向', 'cellType':BasicCell} # DirectionCell
...
class UTOrderMonitor(BasicMonitor):
    """未成交委托监控"""

    def __init__(self, mainEngine, eventEngine, parent=None):
        """Constructor"""

        super(UTOrderMonitor, self).__init__(mainEngine, eventEngine, parent)
        ...
        self.setDataKey('vtOrderID')
        self.setEventType(EVENT_UNTRADE)
        self.setFont(BASIC_FONT)
        # self.setSaveData(True)
...
class PositionMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine, eventEngine, parent=None):
        ...
        d = OrderedDict()
        d['symbol'] = {'chinese':u'合约代码', 'cellType':BasicCell}
        d['vtSymbol'] = {'chinese':u'名称', 'cellType':BasicCell} # NameCell
        d['direction'] = {'chinese':u'方向', 'cellType':BasicCell} # DirectionCell
...
class TradingWidget(QtWidgets.QFrame):
    ...
    def sendOrder(self):
        ...
        #print((req.direction,req.offset))
...
class ContractMonitor(BasicMonitor):
    ...
    def __init__(self, mainEngine=None,eventEngine=None, parent=None):
        ...
        d['OpenRatioByMoney'] = {'chinese': '开仓费率', 'cellType': BasicCell}
        d['OpenRatioByVolume'] = {'chinese': '开仓手续费', 'cellType': BasicCell}
        d['CloseRatioByMoney'] = {'chinese': '平仓费率', 'cellType': BasicCell}
        d['CloseRatioByVolume'] = {'chinese': '平仓手续费', 'cellType': BasicCell}
        d['CloseTodayRatioByMoney'] = {'chinese': '平今费率', 'cellType': BasicCell}
        d['CloseTodayRatioByVolume'] = {'chinese': '平今手续费', 'cellType': BasicCell}

        d['LongMarginRatioByMoney'] = {'chinese': '多头保证金率', 'cellType': BasicCell}
        # d['LongMarginRatioByVolume'] = {'chinese': '多头保证金', 'cellType': BasicCell}
        d['ShortMarginRatioByMoney'] = {'chinese': '空头保证金率', 'cellType': BasicCell}
        # d['ShortMarginRatioByVolume'] = {'chinese': '空头保证金', 'cellType': BasicCell}
    ...
    def showAllContracts(self):
        ...
        for key in l2:
            ...
            if contract.productClass=='组合' or contract.productClass=='未知':
                continue
            for n, header in enumerate(self.headerList):
    ...
    def addMenuAction(self):
        """增加右键菜单内容"""
        refreshAction = QtWidgets.QAction(u'刷新', self)
